				...
				<view v-else class="list-wrap">
					<view class="list-item" v-for="(item, index) in list" :key="item.id || index">
						...
						<view class="item-actions">
							<text class="act" @click.stop="openActionMenu(item)">更多</text>
						</view>
					</view>
				</view>
	...
	export default {
		...
		methods: {
			...
			handleAction(action) {
				...
				if (!this.actionMenuItem) return

				switch (action) {
					case 'toggleStatus':
						this.toggleStatus(this.actionMenuItem)
						break
					case 'edit':
						this.goEdit(this.actionMenuItem)
						break
					case 'delete':
						this.doDelete(this.actionMenuItem)
						break
				}
			},
